...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-us">
  ...
  <body>
    ...
    <div id="wrap">
      <div id="leftcolumn">
        <ul>
          <li><a href="hyra-bostad">Hyra bostad</a></li>
          <li><a href="#2011-04-10">Så kommer du igång</a></li>
          <li><a href="#2011-04-10">Vanliga frågor</a></li>
        </ul>
      </div>

      <div id="content">
        <h1><a name="#hyra-bostad">Hyra bostad.</a></h1>
